    ...
    <section id="about" className="py-6 md:py-16 xl:py-28 w-full">
      <BentoGrid>
        ...
        <BentoGridItem className="sm:col-span-3 md:col-span-4 lg:col-span-4 xl:col-span-2">
          ...
          <p className="text-stone-600 dark:text-stone-300">Focusing on high-concurrency systems and logical efficiency. Turning complexity into invisible infrastructure.</p>
